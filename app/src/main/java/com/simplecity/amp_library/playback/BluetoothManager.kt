...
class BluetoothManager(
    ...
    fun registerBluetoothReceiver(context: Context) {
        ...
        bluetoothReceiver = object : BroadcastReceiver() {
            ...
            private fun handlePauseOnDisconnect(action: String, extras: Bundle) {
                when (action) {
                    BluetoothA2dp.ACTION_CONNECTION_STATE_CHANGED -> {
                        ...
                        if (isA2dpDisconnected(state, previousState)) {
                    ...
                    BluetoothHeadset.ACTION_AUDIO_STATE_CHANGED -> {
                        ...
                        if (isHeadsetAudioDisconnected(state, previousState)) {
                            analyticsManager.dropBreadcrumb(TAG, "ACTION_AUDIO_STATE_CHANGED.. pausing. State: $state")
                            playbackManager.pause(false)
                        }
                    }
            ...
            private fun isA2dpDisconnected(state: Int, previousState: Int): Boolean {
            ...
            private fun isHeadsetAudioDisconnected(state: Int, previousState: Int): Boolean {
